...
const GenericPage: React.FC<GenericPageProps> = ({
    ...
    if (typeof window !== "undefined") {
      ...
      if (typeof (window as any).__sendMessageToBot === "function") {
        ...
        const event = new CustomEvent("open-floating-bot-chat", {
          detail: {
            message: `Je souhaite des informations concernant ${title}`,
          },
        });
  ...
  const getHighlightedTitle = () => {
    ...
    if (highlightWord && title.includes(highlightWord)) {
      ...
      const index = parts.findIndex(
        (part) => part.toLowerCase() === highlightWord.toLowerCase()
      );
  ...
  return (
    <div className="flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
      <div className="w-[96%] bg-[#F3F3F3] rounded-[40px] py-8 sm:py-10 md:py-12 lg:py-16 mt-12 mb-12">
