...
export default function EfficaciteTransfoModal({
    isOpen,
    onClose,
    prestationType,
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[999999] animate-fadeIn">
            ...
            <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-scaleIn mx-4">
                ...
                <div className="bg-gradient-to-r from-[#3E4C70] to-[#2C3650] text-white py-8 px-8 relative overflow-hidden">
                    ...
                    <button
                        onClick={onClose}
                        className="absolute z-10 top-5 right-5 text-white/80 hover:text-white hover:bg-white/10 p-1.5 rounded-full transition-all duration-200"
                        aria-label="Fermer"
                    >
